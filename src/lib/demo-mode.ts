...
export const DEMO_PROJECTS = [
  ...
  },
  {
    id: 'demo-project-002',
    user_id: DEMO_USER.id,
    name: 'Son Môi Ruby - 20/02/2025',
    product_name: 'Son Môi Ruby',
    status: 'completed',
    industry: 'beauty',
    is_public: true,
...
export const DEMO_GENERATED_IMAGES = [
  {
    ...
    title: 'Trà Sen Vàng - Display 1',
    description: 'Ảnh display phong cách sang trọng trên nền trắng',
  ...
  },
  {
    ...
    title: 'Trà Sen Vàng - Model 1',
    description: 'Ảnh model với người mẫu thưởng trà',
    image_url: '/placeholder.svg',
    watermarked_image_url: null,
  ...
  },
  {
    ...
    title: 'Trà Sen Vàng - Social 1',
    description: 'Ảnh tối ưu cho Instagram Story',
    image_url: '/placeholder.svg',
    watermarked_image_url: null,
  ...
  },
  {
    ...
    title: 'Trà Sen Vàng - Seeding 1',
    description: 'Ảnh phong cách user-generated content',
    image_url: '/placeholder.svg',
    watermarked_image_url: null,
  ...
  },
  {
    ...
    image_type: 'display' as const,
    style_name: 'Luxury',
    title: 'Son Môi Ruby - Display 1',
    description: 'Ảnh display son môi phong cách luxury',
    image_url: '/placeholder.svg',
    watermarked_image_url: null,
  ...
  },
  {
    ...
    title: 'Son Môi Ruby - Model 1',
    description: 'Ảnh model với son môi màu ruby',
    image_url: '/placeholder.svg',
    watermarked_image_url: null,
  ...
  },
  {
    ...
    image_type: 'social' as const,
    style_name: 'TikTok',
    title: 'Son Môi Ruby - Social 1',
    description: 'Ảnh tối ưu cho TikTok',
    image_url: '/placeholder.svg',
    watermarked_image_url: null,
  ...
  },
  {
    ...
    title: 'Son Môi Ruby - Seeding 1',
    description: 'Ảnh phong cách review sản phẩm',
    image_url: '/placeholder.svg',
    watermarked_image_url: null,
...
export const DEMO_NOTIFICATIONS = [
  {
    id: 'demo-notif-001',
    user_id: DEMO_USER.id,
    title: 'Chào mừng đến SnapStudio!',
    message: 'Bạn đã nhận 500 điểm miễn phí để trải nghiệm.',
    is_read: false,
    created_at: '2025-01-15T08:00:00.000Z',
  },
  {
    id: 'demo-notif-002',
    user_id: DEMO_USER.id,
    title: 'Bộ ảnh đã hoàn thành',
    message: 'Dự án "Trà Sen Vàng" đã tạo xong 12 ảnh.',
    is_read: true,
...
export const DEMO_POINTS_LEDGER = [
  {
    ...
    user_id: DEMO_USER.id,
    delta: 500,
    reason: 'Đăng ký tài khoản - Tặng điểm',
    created_at: '2025-01-15T08:00:00.000Z',
  },
  {
    id: 'demo-ledger-002',
    user_id: DEMO_USER.id,
    delta: -120,
    reason: 'Tạo bộ ảnh - Trà Sen Vàng',
  ...
  },
  {
    ...
    user_id: DEMO_USER.id,
    delta: -120,
    reason: 'Tạo bộ ảnh - Son Môi Ruby',
