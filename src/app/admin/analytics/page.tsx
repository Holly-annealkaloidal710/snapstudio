...
export default function AnalyticsPage() {
  ...
  const loadAnalytics = async () => {
    try {
      ...
      toast.error(error.message || 'Lỗi khi tải dữ liệu analytics');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Analytics & Báo cáo</h1>
            <p className="text-gray-600">Thống kê người dùng, ảnh tạo và chi phí theo ngày.</p>
          </div>
      ...
      {loading ? (
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card>
              <CardContent className="p-6">
                <div className="text-sm text-gray-600 mb-1">Tổng ảnh (phạm vi)</div>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="text-sm text-gray-600 mb-1">Chi phí/ảnh (VND)</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Phân bố theo loại ảnh</CardTitle>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Phân bố theo gói cước</CardTitle>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
