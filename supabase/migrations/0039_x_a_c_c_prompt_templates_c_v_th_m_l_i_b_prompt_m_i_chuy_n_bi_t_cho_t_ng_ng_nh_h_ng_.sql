-- Step 1: Xóa các templates cũ trong các ngành hàng này để tránh trùng lặp
DELETE FROM public.prompt_templates WHERE industry IN ('f_b', 'beauty', 'fashion', 'mother_baby', 'other');

-- Step 2: Thêm lại toàn bộ bộ templates mới và chuẩn
-- 1. Food & Beverage (f_b)
